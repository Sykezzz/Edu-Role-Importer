#!/usr/bin/env bash
# ═══════════════════════════════════════════════════════════════
#  SKYWARD → EDUPHORIA  |  Mac / Linux Launcher
...
PY_SCRIPT="$SCRIPT_DIR/skyward_to_eduphoria.py"
...
banner "Skyward → Eduphoria Role Importer — Launcher"

# ── Verify main script exists ─────────────────────────────────────────────────
if [ ! -f "$PY_SCRIPT" ]; then
    err "Cannot find skyward_to_eduphoria.py"
    echo "     Make sure LAUNCH_MAC_LINUX.sh and skyward_to_eduphoria.py"
...
info "Launching Skyward to Eduphoria Importer..."
echo
cd "$SCRIPT_DIR"
