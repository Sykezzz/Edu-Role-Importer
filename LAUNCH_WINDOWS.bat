...
title Skyward to Eduphoria — Setup and Launch

REM ═══════════════════════════════════════════════════════════
REM  SKYWARD → EDUPHORIA  |  Windows Launcher
...
echo.
echo  ══════════════════════════════════════════════════════
echo   Skyward ^> Eduphoria Role Importer  —  Launcher
echo  ══════════════════════════════════════════════════════
echo.
...
set "PY_SCRIPT=%SCRIPT_DIR%\skyward_to_eduphoria.py"

if not exist "%PY_SCRIPT%" (
    echo  [ERROR] Cannot find skyward_to_eduphoria.py
    echo          Make sure LAUNCH_WINDOWS.bat and skyward_to_eduphoria.py
...
:launch
echo.
echo  [INFO] Starting Skyward to Eduphoria Importer...
echo.
cd /d "%SCRIPT_DIR%"
